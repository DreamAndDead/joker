...
def filter_illegal_cards(card_symbols):
    return tuple(set(card_symbols).difference(set(symbol_level_map.keys())))

def parse_cards(card_symbols):
    return tuple(map(lambda c: symbol_level_map[c], tuple(card_symbols)))
